...
#   the latest information related to the goods
class Good:
...
# overall good list, wo stock manager have all inforamtion 
good_list = {
...
@app.route('/addGood')
def addGood():
    # process a new good to the list
